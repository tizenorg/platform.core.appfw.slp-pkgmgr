...
int main(int argc, char *argv[])
{
	...
	const char *argv_parser[] = { "/usr/bin/chsmack", "-a", "User", PKG_PARSER_DB_FILE, NULL };
	initdb_xsystem(argv_parser);
	const char *argv_parserjn[] = { "/usr/bin/chsmack", "-a", "User", PKG_PARSER_DB_FILE_JOURNAL, NULL };
	initdb_xsystem(argv_parserjn);
	const char *argv_cert[] = { "/usr/bin/chsmack", "-a", "User", PKG_CERT_DB_FILE, NULL };
	initdb_xsystem(argv_cert);
	const char *argv_certjn[] = { "/usr/bin/chsmack", "-a", "User", PKG_CERT_DB_FILE_JOURNAL, NULL };
