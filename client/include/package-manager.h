 ...
 * @retval	PKGMGR_R_ECOMM	communication error
*/
int pkgmgr_client_usr_deactivate_global_app(pkgmgr_client *pc, const char *appid, pkgmgr_app_handler app_event_cb, uid_t uid);
 ...
 * @retval	PKGMGR_R_ECOMM	communication error
*/
int pkgmgr_client_usr_activate_global_app(pkgmgr_client *pc, const char *appid, pkgmgr_app_handler app_event_cb, uid_t uid);
