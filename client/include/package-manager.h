...
int pkgmgr_client_enable_global_app_splash_screen_for_uid(pkgmgr_client *pc, const char *appid, pkgmgr_app_handler app_event_cb, uid_t uid);
...
int pkgmgr_client_disable_global_app_splash_screen_for_uid(pkgmgr_client *pc, const char *appid, pkgmgr_app_handler app_event_cb, uid_t uid);
