...
{
	/* TODO: use getuid() or GLOBAL_USER? */
	return pkgmgr_client_usr_add_blacklist(pc, pkgid, getuid());
}
...
{
	/* TODO: use getuid() or GLOBAL_USER? */
	return pkgmgr_client_usr_remove_blacklist(pc, pkgid, getuid());
}
...
{
	return pkgmgr_client_usr_check_blacklist(pc, pkgid, getuid());
}
